    ...
    return (
        ...
        >
            <ScrollView contentContainerStyle={styles.innerContainer}>
                ...
                <Button mode="contained" onPress={updateCustomerOnAction} style={[styles.button, styles.updateButton]}>
                    Update
                </Button>
                <Button mode="contained" onPress={deleteCustomer} style={[styles.button, styles.deleteButton]}>
                    Delete
                </Button>
            </ScrollView>
        </KeyboardAvoidingView>
